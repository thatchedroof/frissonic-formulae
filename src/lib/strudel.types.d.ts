...
declare module '@strudel/core' {
   ...
   */
  export type Patternable<T = number> = Pattern | Pattern[] | string | string[] | T | T[] | (T | T[] | Pattern)[]
   ...
   */
  export type PatternTransform<T = number> = (...pats: Patternable<T>[]) => Pattern
   ...
   * returned.
   */
  export const register = (name: string, f: (...args: Pattern[]) => Patternable) => PatternTransform
...
declare module '@strudel/webaudio' {
   ...
   */
  export const superdough: (value: SuperdoughValue, after: TSecond, duration: TSecond) => void
